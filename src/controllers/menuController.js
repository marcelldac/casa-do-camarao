...
export const renderMenu = async (req, res) => {
  ...
  res.render('menu', {
    ...
    restaurantCopyDescription1:
      'O melhor camarão marinho que você verá nas próximas décadas. Uma mistura de suculência e crocância.',
    restaurantMenuImage1:
      'https://istoedinheiro.com.br/wp-content/uploads/sites/17/2023/01/11-3.jpg',
    restaurantMenuTitle1: 'Camarão Carabineiro KG',
    restaurantMenuDescription1:
      'Pescado a mais de 500 metros de profundidade, em fundos de areia jamais tocada, o camarão carabineiro é muito apreciado na Casa do Camarão. De cor vermelha intensa, sabor marcante e alta crocância, ele se destaca pelo tamanho avantajado.',
    restaurantMenuImage2:
      'https://live.staticflickr.com/6234/6380665035_9a530dd1ee_b.jpg',
    restaurantMenuTitle2: 'Camarão da Costa Negra',
    restaurantMenuDescription2:
