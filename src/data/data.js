...
export const shrimpImages = data.map(item => item.url);
export const shrimpTitles = data.map(item => item.title);
export const shrimpDescriptions = data.map(item => item.description);
